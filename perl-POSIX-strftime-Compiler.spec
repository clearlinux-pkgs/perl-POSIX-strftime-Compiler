...
%prep
%setup -q -n POSIX-strftime-Compiler-0.44
cd %{_builddir}
tar xf %{_sourcedir}/libposix-strftime-compiler-perl_0.42-1.debian.tar.xz
cd %{_builddir}/POSIX-strftime-Compiler-0.44
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/POSIX-strftime-Compiler-0.44/deblicense/
...
cp %{_builddir}/POSIX-strftime-Compiler-0.44/LICENSE %{buildroot}/usr/share/package-licenses/perl-POSIX-strftime-Compiler/220fe941787679d8a043c0444548ac186c86f309
